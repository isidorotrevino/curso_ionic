...
var filesystem_1 = require("../classes/filesystem");
var fs = require("fs");
...
postRoutes.post('/', [autenticacion_1.verificaToken], function (req, res) {
    ...
    var imagenes = filesystem.imagenesDeTempAPost(req.usuario._id);
...
postRoutes.get('/', [autenticacion_1.verificaToken], function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                posts = _a.sent();
                res.json({ ok: true, posts: posts, pagina: pagina });
                return [2 /*return*/];
        }
    });
}); });
